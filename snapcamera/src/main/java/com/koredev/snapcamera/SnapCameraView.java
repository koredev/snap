...
public class SnapCameraView extends FrameLayout {
    ...
    public SnapCameraView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressWarnings("WrongConstant")
    public SnapCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * {@link Callback#onPictureTaken(SnapCameraView, byte[])}.
     */
     ...
     * {@link Callback#onVideoRecorded(SnapCameraView, String)}.
    ...
    private class CallbackBridge implements CameraViewImpl.Callback {
        ...
        public void onCameraOpened() {
            ...
            for (Callback callback : mCallbacks) {
                callback.onCameraOpened(SnapCameraView.this);
            }
        }
        ...
        public void onCameraClosed() {
            for (Callback callback : mCallbacks) {
                callback.onCameraClosed(SnapCameraView.this);
            }
        }
        ...
        public void onPictureTaken(byte[] data) {
            for (Callback callback : mCallbacks) {
                callback.onPictureTaken(SnapCameraView.this, data);
            }
        }
        ...
        public void onVideoRecorded(String path) {
            for (Callback callback : mCallbacks) {
                callback.onVideoRecorded(SnapCameraView.this, path);
            }
        }
        ...
        public void onFramePreview(byte[] data, int width, int height, int orientation) {
            for (Callback callback : mCallbacks) {
                callback.onFramePreview(SnapCameraView.this, data, width, height, orientation);
            }
        }
        ...
        public void onMountError() {
            for (Callback callback : mCallbacks) {
                callback.onMountError(SnapCameraView.this);
            }
        }
    ...
    /**
     * Callback for monitoring events about {@link SnapCameraView}.
     */
    ...
    public abstract static class Callback {
         ...
         * @param cameraView The associated {@link SnapCameraView}.
         */
        public void onCameraOpened(SnapCameraView cameraView) {
        }
         ...
         * @param cameraView The associated {@link SnapCameraView}.
         */
        public void onCameraClosed(SnapCameraView cameraView) {
        }
         ...
         */
        public void onPictureTaken(SnapCameraView cameraView, byte[] data) {
        }
         ...
         */
        public void onVideoRecorded(SnapCameraView cameraView, String path) {
        }

        public void onFramePreview(SnapCameraView cameraView, byte[] data, int width, int height, int orientation) {
        }

        public void onMountError(SnapCameraView cameraView) {}
    }
